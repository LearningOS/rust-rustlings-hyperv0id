...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        scores.entry(team_1_name.clone())
            .or_insert(Team { name: team_1_name.clone(), goals_scored: 0, goals_conceded: 0 });
        ...
        scores.entry(team_2_name.clone()).and_modify(|team| {team.goals_conceded += team_1_score;});
        scores.entry(team_1_name).and_modify(|team| {team.goals_conceded += team_2_score;});
    }
    scores
}
